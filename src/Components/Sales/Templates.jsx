...
const handleGeneratePDF = (cardId) => {
  ...
  generatePDF('templatePdfId-'+cardId);
};
const templates = [
  // {
  //   id: 1,
...
const Template = () => {
  ...
  //   }
  //   console.log(`Opening modal with content: ${contentType}`);
  // };
  // const handleOpenModal = (content) => {
  //   console.log("Opening modal with content:", content);
  //   if (content === "PDF") {
...
<Button variant="primary" onClick={() => handleOpenModal("PDF")}>
          ...
          <div className="col-12 col-sm-6 col-md-4" key={template.id}>
            <div className="card shadow-sm">
              <div className="card-body">
                ...
                <div
                  id={`display-section-${template.id}`}
  ...
  {template.displayType} 
                  ...
                  {template.displayType === "visitDisplay" && (
                    <VisitDisplayPdf />
                  )}
                  ...
                  {selectedTemplate?.displayType === template.displayType && (
                    <div>
                      {console.log("selectedTemplate:", selectedTemplate)}{" "}
                      {/* Check if selectedTemplate is set */}
                      {console.log(
                        "template.displayType:",
                        template.displayType
                      )}{" "}
                      {/* Check template's displayType */}
                      {console.log(
                        "Condition matched for displayType:",
                        selectedTemplate?.displayType === template.displayType
                      )}{" "}
                      {/* Verify if the condition matches */}
                      <p>
      ...
      <Grid container spacing={3}>
        <Grid item xs={12} sm={6}>
          ...
          {modalContent === "visitDisplay" && (
            ...
            //   </tbody>
            // </Table>
            <Table bordered className="visit-table" style={{ border:'1px solid'}} id={templateId}>
              <tbody>
                <tr>
                ...
                <tr>
                  <td className="label-cell">
                    Firm Name / PROJECT NAME / WING NO E / UNIT NO 208 - fn/P
                  </td>
                  <td className="value-cell"></td>
                ...
                <tr>
                  <td className="label-cell">
                    This Cost Sheet is valid till (15 days from the date of
                    booking)-
                  </td>
                  <td className="value-cell"></td>
                  <td className="value-cell"></td>
                ...
                <tr>
                  <td className="label-cell">
                    Agreement should be registered within 21 days from the date
                    of Ap
                  </td>
                  <td className="value-cell"></td>
                  <td className="value-cell"></td>
                ...
                <tr>
                  <td className="label-cell">
                    Execution of agreement will be subject to realisation of the
                    payme
                  </td>
                  <td className="value-cell"></td>
                  <td className="value-cell"></td>
                ...
                <tr>
                  <td className="label-cell">
                    Government Charges/taxes are subject to change & would be ap
                  </td>
                  <td className="value-cell"></td>
                  <td className="value-cell"></td>
                </tr>
                <tr>
                  <td className="label-cell">
                    Lumpsum Advance Maintenance Deposit shall be collected at
                    the{" "}
                  </td>
                  <td className="value-cell"></td>
                  <td className="value-cell"></td>
                ...
                <tr>
                  <td className="label-cell">
                    Govt taxes to be paid by the buyer as per prevailing rates.
                  </td>
                  <td className="value-cell"></td>
                  <td className="value-cell"></td>
                </tr>
                <tr>
                  <td className="label-cell">
                    The above mentioned cost is based on the tentative area, the
                    exac
                  </td>
                  <td className="value-cell"></td>
                  <td className="value-cell"></td>
                ...
                <tr>
                  <td className="label-cell">
                    This is purely conceptual & not a legal offering Company
                    reserves
                  </td>
                  <td className="value-cell"></td>
                  <td className="value-cell"></td>
                ...
                <tr>
                  <td className="label-cell">
                    If any case, for any reason the unit is cancelled after
                    registration, t
                  </td>
                  <td className="value-cell"></td>
                  <td className="value-cell"></td>
                ...
                <tr>
                  <td className="label-cell">
                    ***We are concerned about accuracy and timely payment, so
                    custo
                  </td>
                  <td className="value-cell"></td>
                  <td className="value-cell"></td>
      ...
      <DemoContainer components={['DatePicker']}>
        ...
        <Modal.Footer>
          ...
          <Button
            ...
            variant="success"
            onClick={()=>generatePDF(templateId)}
          >
            Generate PDF
          </Button>
          <Button
